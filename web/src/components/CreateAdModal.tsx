          ...
          <Dialog.Title className='text-3xl font-black'>
            ...
            <form className='mt-8 flex flex-col gap-4' onSubmit={handleCreateAd}>
              ...
              <div className='flex flex-col gap-2'>
                ...
                <Input name="name" type="text" placeholder="Selecione o game que deseja jogar" id="name" />
              </div>
              <div className='grid grid-cols-2 gap-6'>
                <div className='flex flex-col gap-2'>
                  <label htmlFor='yearsPlaying'>Joga há quantos anos?</label>
                  <Input name="yearsPlaying" type="text" placeholder="Quantos anos joga?" id="yearsPlaying" />
                </div>
                <div className='flex flex-col gap-2'>
                  <label htmlFor='discord'>Qual seu Discord?</label>
                  <Input name="discord" type="text" placeholder="Usuario#000" id="discord" /> 
                </div>
              </div>
              ...
              <div className='flex gap-6'>
                  ...
                  <div className='flex flex-col gap-2 flex-1'>
                    ...
                    <div className='grid grid-cols-2 gap-2'>
                      ...
                      <Input name="hourEnd" type="time" placeholder='De' id="hourEnd" />
                    </div>
                  </div>
              </div>
